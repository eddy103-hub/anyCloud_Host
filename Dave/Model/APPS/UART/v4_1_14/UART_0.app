...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="UART" URI="http://resources/4.1.14/app/UART/0" description="UART APP configures a USIC channel to perform &#xA;transmit &amp; receive operations using UART protocol." mode="NOTSHARABLE" version="4.1.14" minDaveVersion="4.0.0" instanceLabel="UART_0" appLabel="">
  ...
  <hwResources name="Receive Pin" URI="http://resources/4.1.14/app/UART/0/hwres_port_pad_uart_rx" resourceGroupUri="port/p/*/pad/*" mResGrpUri="port/p/*/pad/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/port5/port5_5.dd#//@provided.16"/>
  </hwResources>
  ...
  <hwResources name="NVIC Node Tx" URI="http://resources/4.1.14/app/UART/0/hwres_nvic_node_tx" resourceGroupUri="resources/48.0.0/peripheral/cpu/0/nvic/interrupt/87" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/cpu/cpu_0.dd#//@provided.20"/>
  </hwResources>
  <hwResources name="NVIC Node Rx" URI="http://resources/4.1.14/app/UART/0/hwres_nvic_node_rx" resourceGroupUri="resources/48.0.0/peripheral/cpu/0/nvic/interrupt/89" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">
  ...
  <hwResources name="Receive Pin" URI="http://resources/4.1.14/app/UART/0/__pin_hwres_port_pad_uart_rx" resourceGroupUri="devicepackage/0/84" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.8"/>
  </hwResources>
  <hwResources name="Transmit Pin" URI="http://resources/4.1.14/app/UART/0/__pin_hwres_port_pad_uart_tx" resourceGroupUri="devicepackage/0/83" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
